                    ...
                    <div class="col-xs-12 col-sm-7 col-md-8 order-2 order-sm-1">
                        ...
                        <div class="checkout-steps">
                            <div id="checkout-account"
                                 class="checkout-step <?php echo is_user_logged_in() ? '' : 'active' ?> ">
                            ...
                            <div id="" class="checkout-step <?php echo is_user_logged_in() ? 'active' : '' ?>">
                                <?php
                                                    ...
                                                    <div class="product">
                                                        ...
                                                        <div class="product-total">
                                                            <span class="woocommerce-Price-amount amount"><bdi>
                                                                    ...
                                                                    <span class="woocommerce-Price-currencySymbol">$</span><?php echo $cart_item['data']->sale_price ?></bdi></span>
                                                            <?php } ?>
                                                            <del class="product-price-regular"><span
                                                                        class="woocommerce-Price-amount amount"><bdi><span
                                                                                class="woocommerce-Price-currencySymbol">$</span><?php echo $cart_item['data']->regular_price ?></bdi></span>
                                                            </del>
                                                        </div>
                                                    </div>
                                                <?php } ?>
