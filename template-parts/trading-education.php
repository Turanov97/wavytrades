    ...
    <div class="entry-content container-fluid py-5">
        <div class="row">
            <div class="col-md-7 col-lg-8">
                <div class="pb-2">
                    <p>Welcome to the Trading Education Center here you can discover some of the most popular trading
                        strategies in the market while getting seasoned insight from veteran traders. Within the Trading
                        ...
                        Simpler Insights, our free newsletter. There are so many resources at your fingertips, so take
                ...
                <div class="pb-4">
                    <form action="/" data-ajax_url="/wp-admin/admin-ajax.php"
                        ...
                        <button class="btn btn-link" type="button" id="search_btn">
                            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="#0a2335"
                ...
                <div class="pt-4">
                    ...
                    <div class="three_recent_posts">
                            ...
                            <div class="slick-list draggable">
                                <div class="slick-track"
                                    ...
                                    while ($loop->have_posts()) : $loop->the_post();
                                        ?>
                                        <li class="mb-3 mb-sm-0 slick-slide slick-current slick-active" data-slick-index="0"
                        ...
                        <div class="arrow_link d-flex align-items-center justify-content-end pt-2">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="#0A2335"
                ...
                <div class="pt-4">
                    ...
                    <div>As we're a collaborative company of like minded traders, we're always looking to provide you
                        with the best market insight and an easy to use experience. If at any time you have any
                        questions, comments, or concerns please feel free to reach out to our awesome customer support
                    ...
                    <div class="card pb-4 pt-4 px-3">
                        <div class="pt-2">
                            ...
                            <div>
                                ...
                                <p>You are logged in. Click <a href="/dashboard">here to go to your dashboard</a></p>
                                    <?php  } else {?>
