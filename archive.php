    ...
    <main id="primary" class="site-main">
        <div class="container-fluid">
            ...
            <header class="page-header">
                <h1 class="entry-title display-3 color_primary pb-4"> <?php echo get_the_category()['0']->name; ?></h1>
                ...
                <div class="d-lg-flex d-grid mb-5 justify-content-center align-items-center">
                    <div class="d-flex align-items-center mx-3">
                        <form action="/" data-ajax_url="/wp-admin/admin-ajax.php" method="get"
                            ...
                            <input type="hidden" name="cat_name" class="form-control" value="<?php echo get_the_category()['0']->name; ?>">
                        </form>
                    </div>
                </div>
                <?php
